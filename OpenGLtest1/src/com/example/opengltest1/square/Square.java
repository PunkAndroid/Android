...
public class Square {
	...
	// The order we like to connect them.定义绘制的顺序
	...
	public Square(){
		// a float is 4 bytes,therfore we multiply the number if vertices with 4.
		...
		// short is 2 bytes, therefor we multiply the number if vertices with 2.
	...
	public void draw(GL10 gl){
		// Counter-clockwise winding. 设置自定义卷绕顺序，逆时针为证明
