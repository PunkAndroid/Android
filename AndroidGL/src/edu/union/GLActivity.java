...
public class GLActivity extends Activity {
    ...
    protected boolean isFullscreenOpaque() {
        // Our main window is set to translucent(透明的), but we know that we will
        // fill it with opaque（不透明的） data. Tell the system that so it can perform
        // some important optimizations（优化）.
        return true;
    }
